...
.extend_handle{position: absolute;left:50%;bottom:30px; width:30px;height: 30px;padding:10px;transform: translate3d(-15px,0,0);cursor: pointer;}
...
.node{position: relative; display: inline-block;box-sizing: border-box; text-align: center;width: 6rem;}
.node .person{position: relative; display: inline-block;z-index: 2; overflow: hidden;width: auto;}
.node .person .avat{display: block;width:1.5em;height: 1.5em;margin:auto;overflow:hidden; background:#fff;box-sizing: border-box;}
.node .person .avat img{width:100%;height: 100%;}
.node .person .name{height:2em;line-height: 2em;overflow: hidden;width:6rem;white-space: nowrap;text-overflow: ellipsis;}
