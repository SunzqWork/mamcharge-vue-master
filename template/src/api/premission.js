...
// 新增类别
export function addType(name, seq) {
    return request({
...
// 修改类别
export function updateType(code, name, status = null, seq) {
    return request({
...
// 组织帮助框
export function orgsTrees(data, info) {
    return request({
        url: `/data/orgs/depts${data == "" || data == undefined ? "" : '?orgId='+data}`,
        method: 'get',
        data
    })
}

export function orgsTreesDep(info) {
    return request({
        url: `/data/orgs/tree?dept=${info}`,
        method: 'get',
    })
}
// 删除角色下面的成员
...
// 修改账号密码---个人信息
export function updatePasswordByUser(id, data) {
    return request({
        url: `/data/users/${id}/pass/`,
        method: 'put',
        data
...
// 角色类别查询
export function roleTypePageQuery(params) {
    return request({
        url: '/data/roles/kinds/page',
        method: 'get',
        params
    })
}
...
// 角色类别删除
export function roltTypeAllDelete(data) {
    return request({
        url: '/data/roles/kinds/batch',
        method: 'delete',
        data
    })
}